...
('root', '[{\"db\":\"pilot_database\",\"table\":\"datafile\"}]');
...
('root', '2017-05-08 13:30:57', '{\"collation_connection\":\"utf8mb4_unicode_ci\"}');
...
--
CREATE DATABASE IF NOT EXISTS `pilot_database` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `pilot_database`;
